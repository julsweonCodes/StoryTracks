...
### 🗺️ 위치 기반 게시물 탐색 (메인 피드)<br>




- 지도 위 클러스터링된 게시물 탐색<br>
<div>
  <img src="imgs/main-feed-1.png" width="45%"/>
  <img src="imgs/main-feed-2.png" width="45%"/>
</div><br><br>

- 지역 마커 클릭 시 해당 위치 게시물 리스트 노출<br><br>
<div>
...
- 이미지 메타데이터(위경도/시간) 분석  
- 글쓰기 스타일 지정 및 Gemini API 기반 요약문 자동 생성<br><br>
<div>
